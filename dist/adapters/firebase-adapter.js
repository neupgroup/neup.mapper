...
export class FirebaseAdapter {
    constructor(config) {
        ...
        try {
            ...
            throw new Error(`Failed to initialize Firebase adapter: ${error.message}\n` +
        ...
        for (const filter of options.filters) {
            ...
            switch (operator) {
                ...
                case 'IN':
                    ...
                    break;
                case 'NOT IN':
                    query = query.where(field, 'not-in', Array.isArray(value) ? value : [value]);
                    break;
                case 'ARRAY_CONTAINS':
     ...
     */
    async rollbackTransaction(batch) {
